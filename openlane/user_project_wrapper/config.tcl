...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$::env(CARAVEL_ROOT)/verilog/rtl/defines.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/wrapped_rc4.v"

set ::env(EXTRA_LEFS) "\
	$::env(DESIGN_DIR)/../../lef/wrapped_rc4.lef"

set ::env(EXTRA_GDS_FILES) "\
	$::env(DESIGN_DIR)/../../gds/wrapped_rc4.gds"
